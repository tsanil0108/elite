...
export default function Navbar() {
  ...
  // Measure the actual rendered height of the fixed header (it changes
  // between mobile/desktop because the top strip is hidden on mobile) and
  // reserve exactly that much space right after it, so page content is
  // never hidden behind it on any page.
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* Spacer: automatically matches the fixed header's real height on
          every page, so content never hides behind it — no manual padding
